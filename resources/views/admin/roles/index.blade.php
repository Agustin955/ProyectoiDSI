            ...
            <tbody>
                @foreach ($roles as $role)
                    <tr>
                       ...
                       <td >
                        <a type="button" class="btn btn-success" href="roles/{{ $role['id'] }}"><i class="fa fa-eye"></i></a>
                        </td>
                          <td>
                            <a type="button" class="btn btn-warning" href="roles/{{ $role['id'] }}/edit"><i class="fa fa-edit"></i></a>
                          </td>
